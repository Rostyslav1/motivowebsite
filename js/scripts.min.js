! function(e, t) {
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, l, u, p, d = t.createDocumentFragment(), h = [], g = 0, v = e.length; v > g; g++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = (Oe.exec(o) || ["", ""])[1].toLowerCase(), l = Pe[a] || Pe._default, s.innerHTML = l[1] + oe.htmlPrefilter(o) + l[2], p = l[0]; p--;) s = s.lastChild;
    ...
    function T(e, t, n, r) {
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = oe.map(c(i, "script"), y), a = s.length; d > f; f++) l = i, f !== h && (l = oe.clone(l, !0, !0), a && oe.merge(s, c(l, "script"))), n.call(e[f], l, f);
            if (a)
                for (u = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) l = s[f], $e.test(l.type || "") && !ke.access(l, "globalEval") && oe.contains(u, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace(Xe, "")))
        }
        return e
    }
    ...
    function H(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = ke.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && He(r) && (o[s] = ke.access(r, "olddisplay", k(r.nodeName)))) : (i = He(r), "none" === n && i || ke.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function W(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], u = oe.css(e, "display"), c = "none" === u ? ke.get(e, "olddisplay") || k(e.nodeName) : u, "inline" === c && "none" === oe.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function() {
        ...
        if (oe.isEmptyObject(p)) "inline" === ("none" === u ? k(e.nodeName) : u) && (d.display = u);
        else {
    ...
    var ce = function(e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : R) !== H && q(t), t = t || H, O)) {
                ...
                if (b.qsa && !X[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== g) h = t, d = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = M), f = k(e), o = f.length, l = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = l + " " + p(f[o]);
        ...
        function m(e, t, n, i, o, s) {
            return i && !i[M] && (i = m(i)), o && !o[M] && (o = m(o, s)), r(function(r, s, a, l) {
                var u, c, f, p = [],
                    ...
                    y = !e || !r && t ? m : v(m, p, e, a, l),
                    x = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, x, a, l), i)
                    for (u = v(x, d), i(u, [], a, l), c = u.length; c--;)(f = u[c]) && (x[d[c]] = !(y[d[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
            ...
            var i = n.length > 0,
                ...
                s = function(r, s, a, l, u) {
                    ...
                    if (d += h, i && h !== d) {
                        ...
                        J.apply(l, m), u && !r && m.length > 0 && d + n.length > 1 && t.uniqueSort(l)
                    }
                    return u && (I = w, N = y), g
                };
            return i ? r(s) : s
        }
        var w, b, T, C, S, k, E, A, N, D, j, q, H, L, O, $, P, W, F, M = "sizzle" + 1 * new Date,
            R = e.document,
            I = 0,
            B = 0,
            z = n(),
        ...
        b = t.support = {}, S = t.isXML = function(e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, L = H.documentElement, O = !S(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), b.attributes = i(function(e) {
            ...
            }, P = [], $ = [], (b.qsa = ve.test(H.querySelectorAll)) && (i(function(e) {
                ...
                b.disconnectedMatch = W.call(e, "div"), W.call(e, "[s!='']:x"), P.push("!=", oe)
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === R && F(R, e) ? -1 : t === H || t.ownerDocument === R && F(R, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return j = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && q(e), n = n.replace(ce, "='$1']"), b.matchesSelector && O && !X[n + " "] && (!P || !P.test(n)) && (!$ || !$.test(n))) try {
                var r = W.call(e, n);
                if (r || b.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (e) {}
            return t(n, H, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== H && q(e), F(e, t)
        }, t.attr = function(e, t) {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (v) {
                            ...
                            } else if (y && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[e] || [], d = u[0] === I && u[1], x = d), x === !1)
                                for (;
                                    (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [I, x]), p !== t)););
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, k = t.tokenize = function(e, n) {
            ...
            var n, r = [],
                ...
                o = X[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;) o = y(t[n]), o[M] ? r.push(o) : i.push(o);
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = de.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)
                    if ((l = T.find[a]) && (r = l(s.matches[0].replace(we, be), ye.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && p(o), !e) return J.apply(n, r), n;
                        break
                    }
            }
            return (u || E(e, f))(r, t, !O, n, !t || ye.test(e) && c(t.parentNode) || t), n
    ...
    oe.extend({
        ...
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, r;
                if (o && void 0 === t) {
                    if (n = Ee.get(o, e) || Ee.get(o, e.replace(Ne, "-$&").toLowerCase()), void 0 !== n) return n;
    ...
    oe.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, s, a, l, u, c, f, p, d, h, g, v = ke.get(e);
            if (v)
        ...
        remove: function(e, t, n, r, i) {
            var o, s, a, l, u, c, f, p, d, h, g, v = ke.hasData(e) && ke.get(e);
            if (v && (l = v.events)) {
    ...
    oe.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, s, a = oe.camelCase(t);
            return t = oe.cssProps[a] || (oe.cssProps[a] = N(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = E(e, t, r)), "normal" === i && t in tt && (i = tt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !ht.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0;
                    (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || d, c = (ke.get(s, "events") || {})[t.type] && ke.get(s, "handle"), c && c.apply(s, n), c = u && s[u], c && c.apply && Se(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
    ...
    At.href = gt.href, oe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, a) {
                var u, f, y, x, b, C = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), i = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, u = t >= 200 && 300 > t || 304 === t, r && (x = _(p, T, r)), x = X(p, x, T, u), u ? (p.ifModified && (b = T.getResponseHeader("Last-Modified"), b && (oe.lastModified[o] = b), b = T.getResponseHeader("etag"), b && (oe.etag[o] = b)), 204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, f = x.data, y = x.error, u = !y)) : (y = C, (t || !C) && (C = "error", 0 > t && (t = 0))), T.status = t, T.statusText = (n || C) + "", u ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, y]), T.statusCode(m), m = void 0, c && h.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? f : y]), v.fireWith(d, [T, C]), c && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
    ...
    oe.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + i) : t.jsonp !== !1 && (t.url += (mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            ...
            void 0 === o ? oe(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, $t.push(i)), s && oe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script") : void 0
    ...
    oe.fn.load = function(e, t, n) {
        ...
        oe.cssHooks[t] = A(re.pixelPosition, function(e, n) {
            return n ? (n = E(e, t), Ye.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    }), oe.each({
        Height: "height",
        Width: "width"
...
function() {
    ...
    $(window).width() > 767 && (new WOW).init(), $("#nav-icon4").click(function() {
        $(this).toggleClass("open"), $(".mob-menu ul").slideToggle()
    }), $("header").css("opacity", "1"), $('input[type="search"]').focus(function() {
        $(this).css("background-positionX", "130%")
    }), $('input[type="search"]').focusout(function() {
        $(this).css("background-positionX", "97%")
    });
    var e = $(".header");
    $(window).scroll(function() {
        $(this).scrollTop() > 80 ? e.addClass("header-on-scroll") : e.removeClass("header-on-scroll"), $(this).scrollTop() > 110 ? e.addClass("header-scroll") : e.removeClass("header-scroll")
    })
}), $(function() {
    $(".main-bg-img").css("transform", "scale(1)");
    var e = ($(window).height() - $("#img").height()) / 1.3;
    $(".section-item-wrapper #img").each(function(e) {
        $(this).addClass("service_img" + e)
    });
    new Waypoint({
        element: $(".service_img0"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img0").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $(".service_img1"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img1").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $(".service_img2"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img2").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $(".service_img3"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img3").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $(".service_img4"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img4").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $(".service_img5"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $(".service_img5").addClass("filter-none")
        },
        offset: e
    });
