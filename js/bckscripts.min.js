! function(e, t) {
    ...
    function u(e, t, n, r) {
        var i, o = 1,
            ...
            c = (oe.cssNumber[t] || "px" !== u && +l) && je.exec(oe.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, l, u, p, d = t.createDocumentFragment(), h = [], g = 0, v = e.length; v > g; g++)
            if (o = e[g], o || 0 === o)
                if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o);
                else if (We.test(o)) {
            for (s = s || d.appendChild(t.createElement("div")), a = (Oe.exec(o) || ["", ""])[1].toLowerCase(), l = Fe[a] || Fe._default, s.innerHTML = l[1] + oe.htmlPrefilter(o) + l[2], p = l[0]; p--;) s = s.lastChild;
        ...
        for (d.textContent = "", g = 0; o = h[g++];)
            ...
            for (p = 0; o = s[p++];) Pe.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function w(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            ke.hasData(e) && (a = ke.access(e), l = oe.extend({}, a), ke.set(t, l))
        }
    }
    ...
    function T(e, t, n, r) {
        ...
        var i, o, s, a, l, u, f = 0,
            ...
            g = t[0],
            v = oe.isFunction(g);
        if (v || d > 1 && "string" == typeof g && !re.checkClone && ze.test(g)) return e.each(function(i) {
            var o = e.eq(i);
            v && (t[0] = g.call(this, i, o.html())), T(o, t, n, r)
        });
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = oe.map(c(i, "script"), m), a = s.length; d > f; f++) l = i, f !== h && (l = oe.clone(l, !0, !0), a && oe.merge(s, c(l, "script"))), n.call(e[f], l, f);
            if (a)
                for (u = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) l = s[f], Pe.test(l.type || "") && !Ee.access(l, "globalEval") && oe.contains(u, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace(Xe, "")))
        }
        return e
    }
    ...
    function E(e) {
        var t = Y,
            n = Ue[e];
        return n || (n = S(e, t), "none" !== n && n || (Qe = (Qe || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Qe[0].contentDocument, t.write(), t.close(), n = S(e, t), Qe.detach()), Ue[e] = n), n
    }
    ...
    function H(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = Ee.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && He(r) && (o[s] = Ee.access(r, "olddisplay", E(r.nodeName)))) : (i = He(r), "none" === n && i || Ee.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function M(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = it || O(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
            ...
            c = u.props;
        for ($(c, u.opts.specialEasing); s > o; o++)
            if (r = M.prefilters[o].call(u, e, c, u.opts)) return oe.isFunction(r.stop) && (oe._queueHooks(u.elem, u.opts.queue).stop = oe.proxy(r.stop, r)), r;
    ...
    oe.fn = oe.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || oe.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], r = e[t], s !== r && (u && r && (oe.isPlainObject(r) || (i = oe.isArray(r))) ? (i ? (i = !1, o = n && oe.isArray(n) ? n : []) : o = n && oe.isPlainObject(n) ? n : {}, s[t] = oe.extend(u, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, oe.extend({
    ...
    var ce = function(e) {
        function t(e, t, n, r) {
            var i, o, s, a, l, u, f, d, h = t && t.ownerDocument,
                g = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g) return n;
            if (!r && ((t ? t.ownerDocument || t : R) !== H && q(t), t = t || H, O)) {
                if (11 !== g && (u = ye.exec(e)))
                    if (i = u[1]) {
                        if (9 === g) {
                ...
                if (b.qsa && !X[e + " "] && (!P || !P.test(e))) {
                    if (1 !== g) h = t, d = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = M), f = E(e), o = f.length, l = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = l + " " + p(f[o]);
                        d = f.join(","), h = me.test(e) && c(t.parentNode) || t
                    }
                    if (d) try {
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (s) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (u = t[M] || (t[M] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[r]) && a[0] === I && a[1] === o) return c[2] = a[2];
        ...
        function y(e, t, n, i, o, s) {
            return i && !i[M] && (i = y(i)), o && !o[M] && (o = y(o, s)), r(function(r, s, a, l) {
                var u, c, f, p = [],
                    d = [],
                    h = s.length,
                    y = r || g(t || "*", a.nodeType ? [a] : a, []),
                    m = !e || !r && t ? y : v(y, p, e, a, l),
                    x = n ? o || (r ? e : h || i) ? [] : s : m;
                if (n && n(m, x, a, l), i)
                    for (u = v(x, d), i(u, [], a, l), c = u.length; c--;)(f = u[c]) && (x[d[c]] = !(m[d[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                            for (u = [], c = x.length; c--;)(f = x[c]) && u.push(m[c] = f);
                            o(null, x = [], u, l)
                        }
                        for (c = x.length; c--;)(f = x[c]) && (u = o ? ee(r, f) : p[c]) > -1 && (r[u] = !(s[u] = f))
                    }
                ...
                if (n = T.relative[e[a].type]) c = [d(h(c), n)];
                    ...
                    if (n = T.filter[e[a].type].apply(null, e[a].matches), n[M]) {
                        ...
                        return y(a > 1 && h(c), a > 1 && p(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(ae, "$1"), n, r > a && m(e.slice(a, r)), i > r && m(e = e.slice(r)), i > r && p(e))
                    }
                    c.push(n)
                }
            return h(c)
            ...
            var i = n.length > 0,
                ...
                s = function(r, s, a, l, u) {
                    var c, f, p, d = 0,
                        ...
                        m = N,
                        x = r || o && T.find.TAG("*", u),
                        w = I += null == m ? 1 : Math.random() || .1,
                        b = x.length;
                    for (u && (N = s === H || s || u); h !== b && null != (c = x[h]); h++) {
                        if (o && c) {
                            for (f = 0, s || c.ownerDocument === H || (q(c), a = !O); p = e[f++];)
                                if (p(c, s || H, a)) {
                                    l.push(c);
                                    break
                                }
                    ...
                    if (d += h, i && h !== d) {
                        ...
                        J.apply(l, y), u && !r && y.length > 0 && d + n.length > 1 && t.uniqueSort(l)
                    }
                    return u && (I = w, N = m), g
                };
            return i ? r(s) : s
        }
        var w, b, T, C, S, E, k, A, N, D, j, q, H, L, O, P, F, W, $, M = "sizzle" + 1 * new Date,
            R = e.document,
            I = 0,
            B = 0,
            z = n(),
        ...
        b = t.support = {}, S = t.isXML = function(e) {
            ...
            return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, L = H.documentElement, O = !S(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), b.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), b.getElementsByTagName = i(function(e) {
                return e.appendChild(H.createComment("")), !e.getElementsByTagName("*").length
            }), b.getElementsByClassName = ve.test(H.getElementsByClassName), b.getById = i(function(e) {
                return L.appendChild(e).id = M, !H.getElementsByName || !H.getElementsByName(M).length
            ...
            }, F = [], P = [], (b.qsa = ve.test(H.querySelectorAll)) && (i(function(e) {
            ...
            })), (b.matchesSelector = ve.test(W = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && i(function(e) {
                b.disconnectedMatch = W.call(e, "div"), W.call(e, "[s!='']:x"), F.push("!=", oe)
            }), P = P.length && new RegExp(P.join("|")), F = F.length && new RegExp(F.join("|")), t = ve.test(L.compareDocumentPosition), $ = t || ve.test(L.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === R && $(R, e) ? -1 : t === H || t.ownerDocument === R && $(R, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return j = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && q(e), n = n.replace(ce, "='$1']"), b.matchesSelector && O && !X[n + " "] && (!F || !F.test(n)) && (!P || !P.test(n))) try {
                var r = W.call(e, n);
                if (r || b.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (e) {}
            return t(n, H, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== H && q(e), $(e, t)
        }, t.attr = function(e, t) {
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (j = !b.detectDuplicates, D = !b.sortStable && e.slice(0), e.sort(Q), j) {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        var u, c, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling",
                            v = t.parentNode,
                        ...
                        if (v) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && m) {
                                for (p = v, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[e] || [], d = u[0] === I && u[1], x = d && u[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [I, d, x];
                                        break
                                    }
                            } else if (m && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), u = c[e] || [], d = u[0] === I && u[1], x = d), x === !1)
                                for (;
                                    (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++x || (m && (f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [I, x]), p !== t)););
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, E = t.tokenize = function(e, n) {
            var r, i, o, s, a, l, u, c = _[e + " "];
            if (c) return n ? 0 : c.slice(0);
            for (a = e, l = [], u = T.preFilter; a;) {
                (!r || (i = le.exec(a))) && (i && (a = a.slice(i[0].length) || a), l.push(o = [])), r = !1, (i = ue.exec(a)) && (r = i.shift(), o.push({
                    value: r,
                    type: i[0].replace(ae, " ")
                }), a = a.slice(r.length));
                for (s in T.filter) !(i = de[s].exec(a)) || u[s] && !(i = u[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && b.getById && 9 === t.nodeType && O && T.relative[o[1].type]) {
                ...
                for (i = de.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)
                    if ((l = T.find[a]) && (r = l(s.matches[0].replace(we, be), me.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && p(o), !e) return J.apply(n, r), n;
                        break
                    }
            }
            return (u || k(e, f))(r, t, !O, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, b.sortStable = M.split("").sort(Q).join("") === M, b.detectDuplicates = !!j, q(), b.sortDetached = i(function(e) {
    ...
    oe.fn.extend({
        ...
        oe.fn[e] = function(n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = oe.filter(r, i)), this.length > 1 && (we[e] || oe.uniqueSort(i), xe.test(e) && i.reverse()), this.pushStack(i)
        }
    });
    var be = /\S+/g;
    oe.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && oe.isFunction(o[i].promise) ? o[i].promise().progress(u(i, n, t)).done(u(i, r, o)).fail(l.reject) : --a;
    ...
    var Ce = function(e, t, n, r, i, o, s) {
            ...
            } else if (void 0 !== r && (i = !0, oe.isFunction(r) || (s = !0), u && (s ? (t.call(e, r), t = null) : (u = t, t = function(e, t, n) {
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (i = ke.get(o), 1 === o.nodeType && !Ee.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--;) s[n] && (r = s[n].name, 0 === r.indexOf("data-") && (r = oe.camelCase(r.slice(5)), l(o, r, i[r])));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, r;
                if (o && void 0 === t) {
                    if (n = ke.get(o, e) || ke.get(o, e.replace(Ne, "-$&").toLowerCase()), void 0 !== n) return n;
    ...
    oe.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, s, a, l, u, c, f, p, d, h, g, v = Ee.get(e);
            if (v)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                        return "undefined" != typeof oe && oe.event.triggered !== t.type ? oe.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(be) || [""], u = t.length; u--;) a = Re.exec(t[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, f.setup && f.setup.call(e, r, h, s) !== !1 || e.addEventListener && e.addEventListener(d, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), oe.event.global[d] = !0)
        },
        remove: function(e, t, n, r, i) {
            var o, s, a, l, u, c, f, p, d, h, g, v = Ee.hasData(e) && Ee.get(e);
            if (v && (l = v.events)) {
                for (t = (t || "").match(be) || [""], u = t.length; u--;)
                    if (a = Re.exec(t[u]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                        for (f = oe.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = l[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o], !i && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
                        s && !p.length && (f.teardown && f.teardown.call(e, h, v.handle) !== !1 || oe.removeEvent(e, d, v.handle), delete l[d])
                    } else
                        for (d in l) oe.event.remove(e, d + t[u], n, r, !0);
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                        for (r = [], n = 0; a > n; n++) o = t[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? oe(i, this).index(l) > -1 : oe.find(i, this, null, [l]).length), r[i] && r.push(o);
                        r.length && s.push({
                            elem: l,
                            handlers: r
                        })
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = Me.test(i) ? this.mouseHooks : $e.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    oe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(re.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || oe.isXMLDoc(e)))
                for (s = c(a), o = c(e), r = 0, i = o.length; i > r; r++) b(o[r], s[r]);
            if (t)
                if (n)
                    for (o = o || c(e), s = s || c(a), r = 0, i = o.length; i > r; r++) w(o[r], s[r]);
                else w(e, a);
    ...
    oe.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = oe.camelCase(t),
                    l = e.style;
                return t = oe.cssProps[a] || (oe.cssProps[a] = N(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : l[t] : (o = typeof n, "string" === o && (i = je.exec(n)) && i[1] && (n = u(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (oe.cssNumber[a] ? "" : "px")), re.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (l[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, s, a = oe.camelCase(t);
            return t = oe.cssProps[a] || (oe.cssProps[a] = N(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = k(e, t, r)), "normal" === i && t in tt && (i = tt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
        ...
        toggle: function(e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() {
                He(this) ? oe(this).show() : oe(this).hide()
            })
        }
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            var o, s, a, l, u, c, f, p = [r || Y],
                d = ne.call(t, "type") ? t.type : t,
                h = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !ht.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !oe.isWindow(r)) {
                    for (l = f.delegateType || d, ht.test(l + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                    a === (r.ownerDocument || Y) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0;
                    (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || d, c = (Ee.get(s, "events") || {})[t.type] && Ee.get(s, "handle"), c && c.apply(s, n), c = u && s[u], c && c.apply && Se(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !Se(r) || u && oe.isFunction(r[d]) && !oe.isWindow(r) && (a = r[u], a && (r[u] = null), oe.event.triggered = d, r[d](), oe.event.triggered = void 0, a && (r[u] = a)), t.result
            }
        },
    ...
    At.href = gt.href, oe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, a) {
                var u, f, m, x, b, C = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), i = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, u = t >= 200 && 300 > t || 304 === t, r && (x = _(p, T, r)), x = X(p, x, T, u), u ? (p.ifModified && (b = T.getResponseHeader("Last-Modified"), b && (oe.lastModified[o] = b), b = T.getResponseHeader("etag"), b && (oe.etag[o] = b)), 204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, f = x.data, m = x.error, u = !m)) : (m = C, (t || !C) && (C = "error", 0 > t && (t = 0))), T.status = t, T.statusText = (n || C) + "", u ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, m]), T.statusCode(y), y = void 0, c && h.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? f : m]), v.fireWith(d, [T, C]), c && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var i, o, s, a, l, u, c, f, p = oe.ajaxSetup({}, n),
                d = p.context || p,
                ...
                T = {
                    ...
                    setRequestHeader: function(e, t) {
                        var n = e.toLowerCase();
                        return w || (e = x[n] = x[n] || e, m[e] = t), this
                    },
            ...
            if (g.promise(T).complete = v.add, T.success = T.done, T.error = T.fail, p.url = ((t || p.url || gt.href) + "").replace(mt, "").replace(Ct, gt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(be) || [""], null == p.crossDomain) {
                u = Y.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), B(St, p, n, T), 2 === w) return T;
            c = oe.event && p.global, c && 0 === oe.active++ && oe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (yt.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = xt.test(o) ? o.replace(xt, "$1_=" + vt++) : o + (yt.test(o) ? "&" : "?") + "_=" + vt++)), p.ifModified && (oe.lastModified[o] && T.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && T.setRequestHeader("If-None-Match", oe.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : p.accepts["*"]);
            for (f in p.headers) T.setRequestHeader(f, p.headers[f]);
            if (p.beforeSend && (p.beforeSend.call(d, T, p) === !1 || 2 === w)) return T.abort();
            b = "abort";
            for (f in {
                    success: 1,
                    error: 1,
    ...
    oe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && Ht.test(this.nodeName) && !qt.test(e) && (this.checked || !Le.test(e))
            }).map(function(e, t) {
                var n = oe(this).val();
    ...
    oe.fn.load = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            var r, i, o, s, a, l, u, c = oe.css(e, "position"),
                f = oe(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = f.offset(), o = oe.css(e, "top"), l = oe.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (r = f.position(), s = r.top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(l) || 0), oe.isFunction(t) && (t = t.call(e, n, oe.extend({}, a))), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + i), "using" in t ? t.using.call(e, p) : f.css(p)
        }
    }, oe.fn.extend({
        offset: function(e) {
    ...
    return oe.noConflict = function(t) {
        return e.$ === oe && (e.$ = Mt), t && e.jQuery === oe && (e.jQuery = $t), oe
    }, t || (e.jQuery = e.$ = oe), oe
}), ! function() {
    "use strict";
...
function(e) {
    e.fn.scrollToID = function(t) {
        var n = {
            speed: 1e3,
            offset: 100
        };
        return e.extend(n, t), this.off("click.scrolltoid").on("click.scrolltoid", function(t) {
            t.preventDefault();
            var r = e(this).attr("href"),
                i = r.split("#"),
                o = i[1],
                s = e("#" + o).offset().top + 110 - n.offset;
            e("body, html").animate({
                scrollTop: s
            }, n.speed)
        }), this
...
function() {
    ...
    t = function() {
        ...
        return e.prototype.extend = function(e, t) {
            ...
            var i;
            return null == t && (t = !1), null == n && (n = !1), null == r && (r = null), null != document.createEvent ? (i = document.createEvent("CustomEvent"), i.initCustomEvent(e, t, n, r)) : null != document.createEventObject ? (i = document.createEventObject(), i.eventType = e) : i.eventName = e,
                i
        ...
        return e.prototype.get = function(e) {
            ...
            var n, r, i, o, s;
            for (s = this.keys, n = i = 0, o = s.length; i < o; n = ++i)
        ...
        return i.prototype.defaults = {
            ...
            if (this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live) return new e(function(e) {
                return function(t) {
                    var n, r, i, o, s;
                    for (s = [], n = 0, r = t.length; n < r; n++) o = t[n], s.push(function() {
                        var e, t, n, r;
            ...
            if (null == e && (e = this.element), 1 === e.nodeType) {
                for (e = e.parentNode || e, i = e.querySelectorAll("." + this.config.boxClass), o = [], n = 0, r = i.length; n < r; n++) t = i[n], s.call(this.all, t) < 0 ? (this.boxes.push(t), this.all.push(t), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(t, !0), o.push(this.scrolled = !0)) : o.push(void 0);
                return o
            }
            ...
            for (n in t) i = t[n], e["" + n] = i, r.push(function() {
                var t, r, s, a;
                for (s = this.vendors, a = [], t = 0, r = s.length; t < r; t++) o = s[t], a.push(e["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = i);
                return a
            }.call(this));
            return r
        }, i.prototype.vendorCSS = function(e, t) {
            var n, i, o, s, a, l;
            for (a = r(e), s = a.getPropertyCSSValue(t), o = this.vendors, n = 0, i = o.length; n < i; n++) l = o[n], s = s || a.getPropertyCSSValue("-" + l + "-" + t);
            return s
    ...
    $(".main-bg-img").css("transform", "scale(1)"), $(window).width() > 767 && (new WOW).init(), $("#nav-icon4").click(function() {
        $(this).toggleClass("open"), $(".mob-menu ul").slideToggle()
    }), $("header").css("opacity", "1")
}), $(function() {
    $(".parent-toggle_menu").hover(function() {
        $(".toggle_menu").stop().slideDown()
    });
    var e = ($(window).height() - $("#img_1").height()) / 1.3;
    new Waypoint({
        element: $("#img_1"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $("#img_1").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $("#img_2"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $("#img_2").addClass("filter-none")
        },
        offset: e
    }), new Waypoint({
        element: $("#img_3"),
        handler: function(e) {
            $(".services-items").removeClass("filter-none"), $("#img_3").addClass("filter-none")
        },
        offset: e
    });
    $(".sidebar-artic").click(function() {
        $(this).nextAll(".list").slideToggle()
    }), $('input[type="search"]').hover(function() {
        $(this).focus()
    }), $('input[type="search"]').focus(function() {
        $(this).css("padding", "4px 20px 4px 15px")
    }), $('input[type="search"]').focusout(function() {
        $(this).css("padding", "4px 25px 4px 10px")
    }), $("a[href*='#']").scrollToID();
    var t = $(".header");
    $(window).scroll(function() {
        $(this).scrollTop() > 76 ? t.addClass("header-on-scroll") : t.removeClass("header-on-scroll")
    })
});